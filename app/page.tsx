...
function FAQItem({ q, a }: { q: string; a: string }) {
  return (
    <details className="group glass-card rounded-2xl overflow-hidden">
      ...
      <p className="px-5 pb-5 text-white/70 leading-relaxed text-sm">{a}</p>
    </details>
  )
}
...
export default function LandingPage() {
  return (
    <div className="hero-gradient min-h-screen">
      ...
      {/* ── Navbar ── */}
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-[#08081a]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Brain className="w-7 h-7 text-purple-400" />
            <span className="font-bold text-lg tracking-tight">Open EMDR</span>
          </div>
      ...
      <section className="pt-32 pb-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <p className="text-white/40 text-sm">One-time payment · Unlimited sessions forever</p>
          </div>

          {/* Social proof bar */}
          <div className="flex flex-wrap justify-center gap-6 text-sm text-white/40">
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-green-400" /> 10,000+ sessions completed</span>
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-green-400" /> 9 in 10 clients feel improvement</span>
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-green-400" /> Recognised by WHO & APA</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-3">What is EMDR?</p>
              ...
              <div className="space-y-4 text-white/70 leading-relaxed">
                ...
                <p>
                  If you feel powerless to escape from the flashbacks and trauma... if you believe you'll never feel normal or joy or peace again... <strong className="text-white">let EMDR try.</strong>
                </p>
                <p>
            ...
            <div className="glass-card rounded-3xl p-8 space-y-6">
              {[
                { icon: <Brain className="w-5 h-5 text-purple-400" />, text: 'Reaches the root cause, not just symptoms' },
                { icon: <ShieldCheck className="w-5 h-5 text-green-400" />, text: 'Recognised by WHO, APA & US Veterans Affairs' },
                { icon: <Clock className="w-5 h-5 text-blue-400" />, text: 'Results often felt in the very first session' },
                { icon: <Heart className="w-5 h-5 text-rose-400" />, text: 'Safe, private, and available anytime' },
              ].map(({ icon, text }, i) => (
      ...
      <section className="py-24 px-4 bg-white/[0.02]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-3">Why Open EMDR</p>
            <h2 className="text-3xl sm:text-4xl font-bold">What Makes EMDR Different?</h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-6">
            {differences.map((d, i) => (
              <div key={i} className="glass-card rounded-2xl p-6 hover:border-purple-500/30 transition-colors">
                <div className="w-11 h-11 rounded-xl bg-white/5 flex items-center justify-center mb-4">{d.icon}</div>
                <p className="text-white/40 text-xs uppercase tracking-widest mb-1">{d.subtitle}</p>
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-3">Real Client Stories</p>
            <h2 className="text-3xl sm:text-4xl font-bold">Deep Healing, Lasting Results</h2>
          </div>
      ...
      <section className="py-24 px-4 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-3">Conditions We Address</p>
          <h2 className="text-3xl sm:text-4xl font-bold mb-12">
            Let EMDR Heal Your Pain From:
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {conditions.map((c) => (
              <span key={c} className="glass-card px-5 py-2.5 rounded-full text-white/80 font-medium text-sm hover:border-purple-500/40 transition-colors cursor-default">
                {c}
              </span>
            ))}
          </div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card rounded-3xl p-10 text-center glow-purple">
            <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-4">The Data Speaks</p>
            <h2 className="text-4xl sm:text-5xl font-black mb-4">
              <span className="gradient-text">9 in 10</span> Clients
            </h2>
            <p className="text-xl text-white/70 mb-8">Feel a noticeable improvement after a single session</p>
            <div className="grid sm:grid-cols-3 gap-6 mt-8 pt-8 border-t border-white/10">
              {[
                ...
                <div key={i}>
                  <p className="text-3xl font-black gradient-text">{stat}</p>
      ...
      <section id="pricing" className="py-24 px-4 bg-white/[0.02]">
        <div className="max-w-lg mx-auto text-center">
          <p className="text-purple-400 font-semibold text-sm uppercase tracking-widest mb-3">Simple Pricing</p>
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Nothing to Lose — But Your Pain</h2>
          ...
          <div className="glass-card rounded-3xl p-8 glow-purple">
            <div className="text-center mb-8">
              <p className="text-white/40 text-sm mb-2">One-time payment</p>
              <div className="flex items-start justify-center gap-1">
                <span className="text-2xl font-bold text-white/60 mt-3">US$</span>
                <span className="text-7xl font-black text-white">49</span>
              </div>
              <p className="text-white/40 text-sm mt-2">Pay once · Access forever</p>
            </div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/30 text-sm mt-4">Secure checkout · Instant access</p>
        </div>
      </section>
      ...
      <footer className="border-t border-white/5 py-10 px-4">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-white/30 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white/50">Open EMDR</span>
          </div>
